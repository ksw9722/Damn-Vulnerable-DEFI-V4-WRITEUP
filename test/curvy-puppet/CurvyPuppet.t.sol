...
import {CurvyAttacker} from "../../src/curvy-puppet/CurvyAttacker.sol";
...
contract CurvyPuppetChallenge is Test {
    ...
    function setUp() public {
        ...
        vm.createSelectFork("https://mainnet.infura.io/v3/c9f0a993abdd443d86c1f3bdc9fbb2dc",20190356);
    ...
    function test_curvyPuppet() public checkSolvedByPlayer {
        //curvePool.lp_token()
        console.log(address(0xDC24316b9AE028F1497c275EB9192a3Ea0f67022).balance);
        console.log(stETH.balanceOf(0xDC24316b9AE028F1497c275EB9192a3Ea0f67022));
        IERC20 lp = IERC20(address(curvePool.lp_token()));
        CurvyAttacker attacker = new CurvyAttacker(address(curvePool),address(lending),treasury, payable(address(weth)),address(lp),alice,bob,charlie,address(permit2),player, address(dvt));
        weth.transferFrom(treasury, address(attacker), TREASURY_WETH_BALANCE-1);
        lp.transferFrom(treasury, address(attacker), TREASURY_LP_BALANCE-1);
