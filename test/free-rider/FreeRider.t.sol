...
import {RiderAttacker} from "../../src/free-rider/RiderAttacker.sol";
...
contract FreeRiderChallenge is Test {
    ...
    function test_freeRider() public checkSolvedByPlayer {
        RiderAttacker attacker = new RiderAttacker{value:0.1 ether}(address(uniswapV2Factory),address(marketplace),address(recoveryManager),address(nft),payable(address(weth)),address(token));
        attacker.attack();
    }
