...
import {WalletAttacker} from "../../src/backdoor/WalletAttacker.sol";
...
contract BackdoorChallenge is Test {
    ...
    function test_backdoor() public checkSolvedByPlayer {
        WalletAttacker attacker = new WalletAttacker(address(singletonCopy),address(walletRegistry),users,address(walletFactory),address(token),recovery);
        attacker.attack();
