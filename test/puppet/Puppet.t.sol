...
contract PuppetChallenge is Test {
    ...
    function test_puppet() public checkSolvedByPlayer {
        ...
        console.log(player);
        PuppetAttacker attacker = new PuppetAttacker{value:PLAYER_INITIAL_ETH_BALANCE}(address(uniswapV1Exchange),address(token),address(lendingPool),player,recovery);
